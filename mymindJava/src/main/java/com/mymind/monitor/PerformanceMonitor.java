package com.mymind.monitor;

import com.mymind.agent.AgentOrchestrator;
import com.mymind.config.mymindProperties;
...
public class PerformanceMonitor {
    ...
    private final mymindProperties properties;
    ...
    public PerformanceMonitor(AgentOrchestrator orchestrator, KnowledgeToolManager toolManager, mymindProperties properties, MeterRegistry meterRegistry) {
        this.orchestrator = orchestrator;
        this.toolManager = toolManager;
        this.properties = properties;
        Gauge.builder("mymind_agent_success_rate", () -> agentSuccessRate).register(meterRegistry);
        this.monitorCollections = Counter.builder("mymind_monitor_collections_total").register(meterRegistry);
        this.monitorCollectionTimer = Timer.builder("mymind_monitor_collection_duration").register(meterRegistry);
    }
