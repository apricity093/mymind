...
public class KnowledgeBaseService {
    ...
    public KnowledgeBaseService(mymindProperties properties, ObjectProvider<VectorStore> vectorStoreProvider, ObjectMapper objectMapper) {
    ...
    public int addDocuments(List<Map<String, String>> inputDocs) {
        ...
        for (Map<String, String> input : inputDocs) {
            ...
            for (int i = 0; i < segments.size(); i++) {
                ...
                metadata.put("source", "mymind-java");
